            ...
            >
                <div className='container-model'>
                    ...
                    <main className='container-content'>
                        ...
                        <h1 className='container-content__title' >{state.textModel.title}</h1>
                        {/* ${isHideOption && 'hide'} */}
                        <div className={`container-content__option ${(state.isFormRegister || state.isFormLogin || state.isFormForgotpassword) ? 'hide' : ""}`}>

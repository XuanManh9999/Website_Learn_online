...
function ModelAuth({ open, loading, setOpen, text }) {
            ...
            >
                <div className='container-model'>
                    ...
                    <footer className='container-model__footer'>
                        <p>{text.footer_desc}<Button type='link' className='container-model__footer--btn'>{text.subTitle == "Đăng ký" ? "Đăng nhập" : "Đăng ký"}</Button></p>
                        <p>Bạn không nhớ mật khẩu?<Button type='link' className='container-model__footer--btn'>Quên mật khẩu?</Button></p>

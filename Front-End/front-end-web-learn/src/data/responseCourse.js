  ...
  "chapterList": [
      {
          ...
          "description": "Đây là một số thuật toán nguyên lý hệ điều hành cơ bản, nhưng nó thường được áp dụng rộng rãi ở các kiến trúc phức tạp, vì vậy việc nắm bắt nó là bắt buộc trước khi muốn đi sâu, và giải quyết các bài toán phức tạp sau này.",
          "videos": [
              {
      ...
      },
      {
          ...
          "description": "Sau khi hiểu về các thuật toán cơ bản trong lập lịch, giờ đã đến lúc chúng ta học sâu hơn về các hệ thống máy tính, cách mà nó cấp phát bộ nhớ như thế nào sẽ được mình chia sẻ ở chương học này.",
          "videos": [
              {
      ...
      },
      {
          ...
          "description": "Các máy tính nhìn rất phức tạp nhưng bên trong nó chứa đựng chi thức của nhân loại, chương này sẽ giúp bạn hiểu hơn về các giải thuật mà máy tính hay làm, chúng ta hãy xem thực sự máy tính nó dùng nó như nào nhé.",
          "videos": [
              {
      ...
      },
      {
          ...
          "description": "Trong chương này chúng ta sẽ tìm hiểu về các thuật toán máy tính dùng để thay thế trang, hãy cùng mình tìm hiểu nó nhé.",
          "videos": [
              {
...
const lofi_chill = {
  ...
  "price": 0,
  "prevPrice": 0,
  "description": "Đây là một số video mình thường nghe khi làm việc, nó giúp mình thỏa mái và tập trung hơn hy vọng bạn cũng thấy vậy.",
  "level": "Cơ bản",
  "author": "Xuân Mạnh",
  "author_img": "https://scontent.fhan17-1.fna.fbcdn.net/v/t39.30808-1/347548956_267208655696795_9021677410419025373_n.jpg?stp=dst-jpg_s200x200&_nc_cat=100&ccb=1-7&_nc_sid=0ecb9b&_nc_eui2=AeF_9lafOGNTrtWDe-WS5dX7_wS9na-lXjX_BL2dr6VeNYvURsdGKooinZx_FmCVld3fSoDZpKRseVgFykj6KYlA&_nc_ohc=FdSkFnC2MF0Q7kNvgEhBDIa&_nc_zt=24&_nc_ht=scontent.fhan17-1.fna&_nc_gid=A-lJkQBbpf1R1w-2KMmwb9k&oh=00_AYBZiPo0lzG7AY5FrU_waiLi5Jarwgw3CwmzeJWrgotT0g&oe=673AA2D4",
  "icon": "https://example.com/icons/java-icon.png",
  ...
  "chapterList": [
    {
      ...
      "description": "Đây là một danh sách nhạc lofi chill không lời do mình tự tổng hợp.",
      "videos": [
        {
